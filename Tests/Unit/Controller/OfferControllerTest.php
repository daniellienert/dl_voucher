...
/**
 * Test case for class Tx_Dl_voucher_Controller_OfferController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_voucher_Controller_OfferControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
