...
/**
 * Test case for class Tx_Dl_voucher_Controller_OrderController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_voucher_Controller_OrderControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
